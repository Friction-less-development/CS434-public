...
#Purpose of program: Final project for Individual Test Subject 2 using decision tree as our model
...
# print classWeights
classWeights[0] = classWeights[0]/classWeights[1] # can only put class weight of 0 in, so divide it by the wiehgt of class weight of 1, more or less.
# print classWeights
...
# # print FTESTLIST[0][0]
# # print FTESTLIST[0][1]
print "Starting Subject 2 Part 2 Test"
print 32*"-"
predictX = []
xAccuracy = []
